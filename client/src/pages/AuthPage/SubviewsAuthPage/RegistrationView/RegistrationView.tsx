...
function RegistrationView({onSuccess}: RegistrationProps) {
    ...
    return (
        <div className={styles['registration-view']}>
            <form onSubmit={(e) => {e.preventDefault(); handleRegister()}}>
                ...
                {errors.generalErr && <span className={styles['form-error']}>{errors.generalErr}</span>}
                <button type="submit" className={styles['auth-submit']}> Register </button>
